  ...
  return (
    <div className="max-w-3xl mx-auto text-center">
      ...
      {user ? (
        ...
        <div>
          <p className="mb-4">Please login or register to enroll.</p>
          <Link href="/login?redirect=/foundation/checkout" className="btn-primary inline-block mr-4">
            Login
          </Link>
          <Link href="/register?redirect=/foundation/checkout" className="btn-outline inline-block">
            Register
          </Link>
        </div>
      )}
