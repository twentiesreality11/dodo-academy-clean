  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="text-center mb-8">
        <h1 className="text-4xl font-bold mb-4 text-[#0B1E33]">Privacy Policy</h1>
        <div className="w-20 h-1 bg-[#FFB347] mx-auto"></div>
        <p className="text-gray-600 mt-4">Last updated: April 9, 2026</p>
      </div>
      ...
      <div className="bg-white rounded-2xl p-8 shadow-md space-y-6">
        ...
        <section>
          ...
          <ul className="list-disc list-inside text-gray-700 space-y-1 ml-4 mt-2">
            ...
            <li>Secure HTTPS connections (SSL/TLS)</li>
        ...
        <section>
          ...
          <p className="text-gray-700 leading-relaxed">
            We use cookies and similar tracking technologies to enhance your experience, analyze usage, and personalize content. Types of cookies we use:
          </p>
          <ul className="list-disc list-inside text-gray-700 space-y-1 ml-4 mt-2">
        ...
        <section>
          ...
          <p className="text-gray-700 leading-relaxed">
            Our services are not intended for individuals under 16. We do not knowingly collect information from children under 16. If you believe a child has provided us with personal information, please contact us.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-700 leading-relaxed">
            Your information may be transferred to and processed in countries other than Nigeria. We ensure appropriate safeguards are in place for such transfers, including standard contractual clauses.
          </p>
        </section>

        <section>
          <h2 className="text-2xl font-bold text-[#0B1E33] mb-3">10. Data Retention</h2>
          <p className="text-gray-700 leading-relaxed">
            We retain your personal information for as long as your account is active or as needed to provide services. We may retain certain information for legal compliance, fraud prevention, and legitimate business purposes.
          </p>
        </section>

        <section>
          <h2 className="text-2xl font-bold text-[#0B1E33] mb-3">11. Changes to This Policy</h2>
          <p className="text-gray-700 leading-relaxed">
            We may update this Privacy Policy periodically. We will notify you of significant changes via email or website notice. The "Last updated" date at the top indicates when changes were made.
          </p>
        </section>

        <section>
          <h2 className="text-2xl font-bold text-[#0B1E33] mb-3">12. Contact Us</h2>
          <p className="text-gray-700 leading-relaxed">
          ...
          <ul className="list-none text-gray-700 space-y-1 mt-2">
            ...
            <li><strong>Data Protection Officer:</strong> dpo@dodoacademy.ng</li>
          </ul>
        </section>
      </div>
    </div>
