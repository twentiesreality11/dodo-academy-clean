...
`;a.s(["CheckmarkIcon",0,Q,"ErrorIcon",0,L,"LoaderIcon",0,N,"ToastBar",0,Y,"ToastIcon",0,V,"Toaster",0,({reverseOrder:a,position:b="top-center",toastOptions:d,gutter:f,children:g,toasterId:h,containerStyle:i,containerClassName:j})=>{let{toasts:k,handlers:l}=H(d,h);return e.createElement("div",{"data-rht-toaster":h||"",style:{position:"fixed",zIndex:9999,top:16,left:16,right:16,bottom:16,pointerEvents:"none",...i},className:j,onMouseEnter:l.startPause,onMouseLeave:l.endPause},k.map(d=>{let h,i,j=d.position||b,k=l.calculateOffset(d,{reverseOrder:a,gutter:f,defaultPosition:b}),m=(h=j.includes("top"),i=j.includes("center")?{justifyContent:"center"}:j.includes("right")?{justifyContent:"flex-end"}:{},{left:0,right:0,display:"flex",position:"absolute",transition:c?void 0:"all 230ms cubic-bezier(.21,1.02,.73,1)",transform:`translateY(${k*(h?1:-1)}px)`,...h?{top:0}:{bottom:0},...i});return e.createElement(Z,{id:d.id,key:d.id,onHeightUpdate:l.updateHeight,className:d.visible?$:"",style:m},"custom"===d.type?s(d.message,d):g?g(d):e.createElement(Y,{toast:d,position:j}))}))},"default",0,F,"resolveValue",0,s,"toast",0,F,"useToaster",0,H,"useToasterStore",0,D],6704)},42974,a=>{"use strict";var b=a.i(87924),c=a.i(72131),d=a.i(38246),e=a.i(92376);a.s(["default",0,function(){let[a,f]=(0,c.useState)(null),[g,h]=(0,c.useState)(!1),i=(0,e.usePathname)(),j=(0,e.useRouter)();async function k(){try{let a=await fetch("/api/auth/me"),b=await a.json();b.user&&f(b.user)}catch(a){console.error("Error fetching user:",a)}}async function l(){await fetch("/api/auth/logout",{method:"POST"}),f(null),j.push("/")}return(0,c.useEffect)(()=>{k()},[]),(0,b.jsx)("header",{className:"bg-[#0B1E33] text-white sticky top-0 z-50 shadow-md",children:(0,b.jsx)("nav",{className:"max-w-7xl mx-auto px-4 py-4",children:(0,b.jsxs)("div",{className:"flex flex-wrap items-center justify-between gap-4",children:[(0,b.jsx)(d.default,{href:"/",className:"text-2xl font-bold bg-gradient-to-r from-white to-[#FFB347] bg-clip-text text-transparent",children:"Dodo Academy"}),(0,b.jsx)("button",{onClick:()=>h(!g),className:"md:hidden text-white focus:outline-none",children:(0,b.jsx)("svg",{className:"w-6 h-6",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:g?(0,b.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M6 18L18 6M6 6l12 12"}):(0,b.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M4 6h16M4 12h16M4 18h16"})})}),(0,b.jsxs)("div",{className:`${g?"flex":"hidden"} md:flex flex-col md:flex-row w-full md:w-auto gap-4 md:gap-6 items-center mt-4 md:mt-0`,children:[(0,b.jsx)(d.default,{href:"/",className:`hover:text-[#FFB347] transition ${"/"===i?"text-[#FFB347]":""}`,children:"Home"}),(0,b.jsx)(d.default,{href:"/critical",className:`hover:text-[#FFB347] transition ${"/critical"===i?"text-[#FFB347]":""}`,children:"Critical Infrastructure"}),(0,b.jsx)(d.default,{href:"/foundation",className:`hover:text-[#FFB347] transition ${"/foundation"===i?"text-[#FFB347]":""}`,children:"Foundation Course"}),(0,b.jsx)(d.default,{href:"/consultancy",className:`hover:text-[#FFB347] transition ${"/consultancy"===i?"text-[#FFB347]":""}`,children:"Consultancy"}),a?(0,b.jsxs)(b.Fragment,{children:[(0,b.jsx)(d.default,{href:"/foundation/dashboard",className:"hover:text-[#FFB347] transition",children:"Dashboard"}),(0,b.jsxs)("button",{onClick:l,className:"bg-[#FFB347] text-[#0B1E33] px-4 py-2 rounded-full font-semibold hover:bg-[#FFC97A] transition",children:["Logout (",a.name,")"]})]}):(0,b.jsxs)(b.Fragment,{children:[(0,b.jsx)(d.default,{href:"/login",className:"hover:text-[#FFB347] transition",children:"Login"}),(0,b.jsx)(d.default,{href:"/register",className:"bg-[#FFB347] text-[#0B1E33] px-4 py-2 rounded-full font-semibold hover:bg-[#FFC97A] transition",children:"Register"})]})]})]})})})}])}];

//# sourceMappingURL=%5Broot-of-the-server%5D__0n7nn3w._.js.map